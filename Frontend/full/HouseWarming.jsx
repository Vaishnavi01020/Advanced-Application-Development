...
import image from '../assets/images/hw1.jpg';
import image1 from '../assets/images/hw2.png';
import image2 from '../assets/images/house3.jpg';
import '../assets/css/HouseWarming.css';
...
function HouseWarming() {
  ...
  return (
    <div className='hw-page'>
      ...
      <div className="hw-container" style={{ width:"90%", height: '20%' }}>
  <div className="hw-image-container">
    <img src={image1} alt="Placeholder" />
  </div>
        <div className="hw-text-container" >
          <h2 className="hw-basic" style={{ top: "100%" }}>Basic Package</h2>
          <ul>
  ...
  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
    ...
    <button style={{ width: '150px', height: '40px', backgroundColor: '#007bff', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer', outline: 'none' }} onClick={() => handleViewAlbumsClick(image4)}>
      View Albums
            ...
            <div className="hw-amount">Amount: $200</div>
      ...
      <div className="hw-container" style={{ width: "90%", height: '20%' }}>
        ...
        <div className="hw-text-container">
          <h2 className="hw-elite">Elite Package</h2>
          <ul>
  ...
  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
    ...
    <button style={{ width: '150px', height: '40px', backgroundColor: '#007bff', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer', outline: 'none' }} onClick={() => handleViewAlbumsClick(image4)}>
      View Albums
            ...
            <div className="hw-amount">Amount: $300</div>
            <button style={{ left: "30%",top:"95%"}} >
              Add To Cart
            </button>
          </div>
      ...
      <div className="hw-container" style={{ width: "90%", height: '20%' }}>
        ...
        <div className="hw-text-container">
          <h2 className="hw-elite">Celebrity Package</h2>
          <ul>
...
<div className="hw-read-more">
  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
    ...
    <button style={{ width: '150px', height: '40px', backgroundColor: '#007bff', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer', outline: 'none' }} onClick={() => handleViewAlbumsClick(image4)}>
      ...
      {popupContent && (
        <div className="hw-popup">
          <div className="hw-popup-content">
            <span className="hw-close" onClick={handleClosePopup}>×</span>
            <p>
              {popupContent.split('\n').map((item, index) => (
                <span key={index}>
                  {item}
